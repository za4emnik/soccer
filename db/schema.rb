...
ActiveRecord::Schema.define(version: 20_180_405_143_443) do
  ...
  create_table 'tournaments_users', id: false, force: :cascade do |t|
    ...
    t.index %w[tournament_id user_id], name: 'index_tournaments_users_on_tournament_id_and_user_id'
    t.index %w[user_id tournament_id], name: 'index_tournaments_users_on_user_id_and_tournament_id'
  end
